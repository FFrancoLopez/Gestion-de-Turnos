...
const User_1 = require("./User"); // Importa la entidad User
const IAppointment_1 = require("../interfaces/IAppointment"); // Enum Status
...
__decorate([
    (0, typeorm_1.Column)({ type: "varchar", length: 10, nullable: false, default: IAppointment_1.Status.Active }),
    __metadata("design:type", String)
